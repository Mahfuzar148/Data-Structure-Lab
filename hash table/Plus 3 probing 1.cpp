...
void plus3ProbingInsert(int key) {
    ...
    while (plus3ProbingTable[index] != -1) {
        ...
        // Handle the case when the hash table is full
...
int main() {
    ...
    plus3ProbingInsert(5);
    plus3ProbingInsert(42);
    plus3ProbingInsert(13);
    plus3ProbingInsert(25);
    plus3ProbingInsert(5);  // Attempt to insert when hash table is full
    plus3ProbingInsert(47);
    plus3ProbingInsert(14);
    plus3ProbingInsert(26);
    plus3ProbingInsert(6);
    plus3ProbingInsert(42);
    plus3ProbingInsert(13);
